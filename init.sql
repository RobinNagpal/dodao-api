...
insert into spaces
(id, verified, created_at, creator, name, updated_at, avatar, admins, admin_usernames, domains, skin, discord_invite, telegram_invite, invite_links, auth_settings, guide_settings, social_settings, byte_settings, features, "botDomains", theme_colors, admin_usernames_v1, type)
values
(
'test-tidbits',
true,
