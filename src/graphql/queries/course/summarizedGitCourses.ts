import { QuerySummarizedGitCoursesArgs } from '@/graphql/generated/graphql';

import { getAllGitGitCoursesForSpace } from '@/helpers/course/gitCourseReader';
import { prisma } from '@/prisma';
import { Space } from '@prisma/client';

export default async function summarizedGitCourses(_: any, args: QuerySummarizedGitCoursesArgs) {
  const { spaceId } = args;
