import { ImageSource, MutationUploadImageFromUrlToS3Args } from '@/graphql/generated/graphql';
...
export default async function uploadImageFromUrlToS3(_: unknown, args: MutationUploadImageFromUrlToS3Args, context: IncomingMessage) {
  try {
